...
<?php 
	$pengguna 	= mysqli_query($connect, "SELECT * FROM pengguna WHERE id = '".$_GET['id']."' ");
				...
				<div class="box-body">
					...
					<form action="" method="POST">
						...
						<div class="form-group">
							<label>Nama</label>
							<input type="text" name="nama" placeholder="Nama Lengkap" class="input-control" value="<?= $p->nama ?>" autocomplete="off">
						</div>
						
						<div class="form-group">
							<label>Username</label>
							<input type="text" name="user" placeholder="Username" class="input-control" value="<?= $p->username ?>" autocomplete="off">
						</div>
